...
public class MainActivity extends AppCompatActivity {
    ...
    /**
     * OnClick method called when the factorial Button is pressed.
     */
    ...
    /**
     * OnClick method called when the logarith Button is pressed.
     */
    public void onLogarith(View view) {
        compute(Calculator.Operator.LOGARITH);
    }
    ...
    private void compute(Calculator.Operator operator) {
        ...
        switch (operator) {
            ...
            case POW:
                ...
                break;
            case FACTORIAL:
                if( mCalculator.factorial((int)operandOne) == 0){
                    result = "overvalued";
                }else {
                    result = String.valueOf(
                            mCalculator.factorial((int) operandOne));
                }
                break;
            case LOGARITH:
                result = String.valueOf(
                        mCalculator.logarith(operandOne, operandTwo));
                break;
            default:
                result = "";
                break;
